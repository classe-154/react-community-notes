...
|**Categoria**|**Significato**|**Esempio Comune**|
|---|---|---|
|**2xx (Successo)**|Semaforo verde. La richiesta è stata gestita correttamente.|`200 OK` o `201 Created`|
|**3xx (Reindirizzamento)**|La risorsa si è spostata.|`301 Moved Permanently`|
|**4xx (Errore Client)**|Qualcosa è andato storto lato utente (richiesta errata).|`404 Not Found` o `401 Unauthorized`|
|**5xx (Errore Server)**|Problemi critici lato server. Il server è andato in crash.|`500 Internal Server Error`|
